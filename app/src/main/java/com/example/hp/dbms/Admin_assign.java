...
public class Admin_assign extends AppCompatActivity {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (k == 1) {
                    if (i != 0) {
                        ...
                        Toast.makeText(Admin_assign.this, "id" + ing + "nam" + y1, Toast.LENGTH_SHORT).show();
                        Toast.makeText(Admin_assign.this, "ID=" + ing + " set as leader", Toast.LENGTH_SHORT).show();
                        db1.insertEntry("emp_" + ing, n1, 0, "leader");
